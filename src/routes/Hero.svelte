<section class='flex w-[100vw] text-white border border-white'>
    <div class='flex flex-col justify-center pl-48 w-[50%] radial-gradient-bl'>
        ...
        <div id='cta-buttons' class='flex justify-between w-[50%]'>
            ...
            <a target='_blank' class='flex justify-center items-center border border-[#F2FF49] text-white rounded-full text-xs p-2' id='contact-link' href='https://linktr.ee/stevenboutcher'>CONTACT ME</a>
        </div>
    </div>
    <div class='w-[50%] flex justify-center p-10 radial-gradient-tr'>
        <div class='flex justify-center w-[50%] p-2 bg-gradient-to-tr from-[#1B5299] via-[#C5C5C5] to-[#F2FF49] rounded-xl'>
