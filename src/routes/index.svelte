<header class="flex flex-col items-center">
    <h1 class="text-4xl">Steven Boutcher</h1>
    <h2 class="text-xl">Engineer of Websites, Docs, Tests, and Sweet Parkour Moves</h2>
</header>

<h3 class="text-xl">About Me</h3>
<section>
    <p>
        For those interested in the long version, go 
        <a href="https://blog.stevenboutcher.com/my-tech-career-origin-story-part-i">
            here
        </a>
    </p>
    <p>
        For the rest of you, hi, I'm Steven! Thanks for stopping by!
        I made the decision in 2017 to learn web development in my spare time and now I'm an SDET at Fetch Rewards. 
        Between then and now, I've met the love of my life and married her, been a dog dad, a cat dad, traveled overseas and domestically, and lots of other stuff! 
        Basically, my story is one of a guy who:
    </p>
        <ul>
            <li>loves to learn new things and experience the world</li>
            <li>gets to experience the joys & sorrows of clinically diagnosed ADHD</li>
            <li>came from a middle-class home in a small city in Wisconsin</li>
            <li>enjoys pickled jalapeños almost more than cheese</li>
            <li>worked a lot of thankless customer service jobs before deciding he could do better</li>
            <li>is always looking for ways to make life easier for others (and himself)</li>
            <li>switched his college major 5 times and still chose the wrong one</li>
            <li>isn't buying any of the lies about coffee being bad for you</li>
        </ul>
    <p>
